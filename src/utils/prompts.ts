...
export const executeTaskPrompt = new PromptTemplate({
  template:
    'You are MackGPT. You must answer in the "{language}" language. Given the following overall objective `{goal}` and the following sub-task, `{task}`. Perform the task.',
